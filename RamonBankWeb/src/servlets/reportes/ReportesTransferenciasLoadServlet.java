 ...
 */
public class ReportesTransferenciasLoadServlet extends BaseServiciosServlet  {
	...
	protected void Accion(HttpServletRequest request,
		...
		request.getRequestDispatcher("/reportes/transferencias.jsp").forward(request, response);
	}
}
